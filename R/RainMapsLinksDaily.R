...
#' @examples
#' RainMapsLinksDaily <- function(AlphaLinksDaily=AlphaLinksDaily,
...
#' ColourPlotLocationText=ColourPlotLocationText,ColourType=ColourType,
#' ColourHighestClass=ColourHighestClass,
...
#' DateTimeStartRainMaps=DateTimeStartRainMaps,
#' ExtraDeg=ExtraDeg,ExtraText=ExtraText,
#' FigFileLinksDaily=FigFileLinksDaily,FigHeight=FigHeight,
#' FigWidth=FigWidth,FileGrid=FileGrid,FilePolygonsGrid=FilePolygonsGrid,
#' FolderFigures=FolderFigures,FolderRainMaps=FolderRainMaps,
#' FolderRainEstimates=FolderRainEstimates,FontFamily=FontFamily,
...
#' GoogleLocNameSpecified=GoogleLocNameSpecified,
...
#' LabelAxisLonOSM=LabelAxisLonOSM,LatLocation=LatLocation,
#' LatText=LatText,LegendTitleLinksDaily=LegendTitleLinksDaily,
...
#' OSMRight=OSMRight,OSMScale=OSMScale,OSMTop=OSMTop,Palette=Palette,
...
#' ScaleTopDaily=ScaleTopDaily,SizeLinks=SizeLinks,
...
#' TIMESTEP=TIMESTEP,TitleLinks=TitleLinks,
...
RainMapsLinksDaily <- function(AlphaLinksDaily,AlphaPlotLocation,AlphaPolygon,AlphaScale,
...
Palette,PERIOD,PlotLocation,PixelBorderCol,PlotBelowScaleBottom,PlotLocLinks,
...
SizePlotTitle,SymbolPlotLocation,TIMESTEP,TitleLinks,XMiddle,YMiddle)
{
	...
	reverse = TRUE,keywidth=10,keyheight=10,title=LegendTitleLinksDaily)) 
	if (AutDefineLegendTop!="yes")
	{
