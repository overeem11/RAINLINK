...
#' @description Function which visualises radar rainfall depths for chosen TIMESTEP in configuration file. Requires interpolation grid and file with polygons of pixels.
...
#'   \item FileNameRadarTimeStep: Filename of radar file of rainfall depths to be visualised (ASCII file).
#' }
...
RainMapsRadarsTimeStep <- function()
{
	...
	for (FileNr in 1:1)
	{
		...
		FigFilename <- paste(FolderFigures,"/",FigFileRadarsTimeStep,EndDateTimeFile,".jpeg",sep="")
