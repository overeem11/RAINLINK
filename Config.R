...
# Name of file with polygons of interpolation grid:
...
AlphaScale <- 0.2  	# AlphaScale <- 0.5 does not give any transparency.
AlphaPolygon <- 0.6
...
ScaleLow <- c(ScaleBottomDaily,6,11,16,21)	# Use ScaleBottomTimeStep or ScaleBottomDaily as first argument.
ScaleHigh <- c(6,11,16,21,26)
# Please note that in case of x values in ColoursNumber, ScaleLow and ScaleHigh should also contain x values.


# Colour of highest class:
